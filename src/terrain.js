...
export const terrain = (function() {
  ...
  const _BLACK = new THREE.Color(0x383734);
  const _GREY = new THREE.Color(0x8f8e8c);
  ...
  class HyposemetricTints {
    constructor(params) {
      ...
      // Arid
      this._colourSpline[0].AddPoint(0.0, new THREE.Color(0x8f8e8c));
      this._colourSpline[0].AddPoint(0.5, new THREE.Color(0x8a8884));
      this._colourSpline[0].AddPoint(1.0, _BLACK);
  
      // Humid
      this._colourSpline[1].AddPoint(0.0, _GREY);
      this._colourSpline[1].AddPoint(0.5, new THREE.Color(0x8f8e8c));
      this._colourSpline[1].AddPoint(1.0, _BLACK);
